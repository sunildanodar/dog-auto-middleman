# Ensure all config variables are importable
__all__ = [
	"TOKEN", "BLOCKCYPHER_TOKEN", "MASTER_PRIVATE_KEY", "MASTER_ADDRESS", "LOG_CHANNEL_ID", "PROOF_CHANNEL_ID", "CONFIRMATIONS_REQUIRED", "FEE_PERCENT", "PAYMENT_TIMEOUT_MINUTES", "PAYMENT_POLL_INTERVAL_SECONDS", "LTC_NETWORK_FEE_USD", "LTC_FEE_BUFFER_SATOSHIS", "EVM_GAS_LIMIT_MULTIPLIER_BPS", "EVM_GAS_FEE_BUFFER_WEI", "DB_NAME", "DB_BACKUP_DIR", "DB_BACKUP_INTERVAL_MINUTES", "DB_BACKUP_RETENTION_DAYS", "DB_BACKUP_MAX_FILES", "BACKUP_EXPORT_DIR", "BACKUP_EXPORT_MAX_FILES", "BACKUP_ALERT_MAX_AGE_MINUTES", "BACKUP_STARTUP_MAX_AGE_MINUTES", "BACKUP_ENCRYPTION_KEY", "STRICT_KEY_FINGERPRINT", "REQUIRE_PERSISTENT_DB", "ALLOW_FAKE_PAYMENTS", "CODE_VERSION", "TICKET_CATEGORY_ID", "ADMIN_ID"
]
...
CONFIRMATIONS_REQUIRED = _env_int("CONFIRMATIONS_REQUIRED", 1)
FEE_PERCENT = _env_int("FEE_PERCENT", 2)
PAYMENT_TIMEOUT_MINUTES = _env_int("PAYMENT_TIMEOUT_MINUTES", 20)
PAYMENT_POLL_INTERVAL_SECONDS = _env_int("PAYMENT_POLL_INTERVAL_SECONDS", 20)
LTC_NETWORK_FEE_USD = 0.0
LTC_FEE_BUFFER_SATOSHIS = _env_int("LTC_FEE_BUFFER_SATOSHIS", 5000)
EVM_GAS_LIMIT_MULTIPLIER_BPS = _env_int("EVM_GAS_LIMIT_MULTIPLIER_BPS", 12000)
EVM_GAS_FEE_BUFFER_WEI = _env_int("EVM_GAS_FEE_BUFFER_WEI", 100000000000000)
...
ALLOW_FAKE_PAYMENTS = _env_bool("ALLOW_FAKE_PAYMENTS", True)
